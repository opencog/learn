#! /usr/bin/env perl
#
# Old version, its use is ... discouraged. See bug
# https://github.com/singnet/language-learning/issues/179
# This version uses netcat to make a server round-trip, which creates
# a huge idle delay, as we wait for the OS kernel scheduler to run us
# again.  use `submit-one.pl` instead.
#
