#!/bin/bash
#
# mpg-one.sh <lang> <filename> <cogserver-host> <cogserver-port>
#
# Support script for MPG processing (disjunct counting) of text files.
# Sentence-split one file, submit it, via perl script, to the cogserver.
# When done, move the file over to the `mpg-articles` directory.
#
# Example usage:
#    ./mpg-one.sh en Barbara localhost 17001
#
